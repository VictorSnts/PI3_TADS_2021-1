...
public class RelatorioDAO {
    ...
    public static List<Relatorio> getVendasIntervalo(int filial_usuario, String data_inicial, String data_final, int codCliente_selecionado) {
        String query = "SELECT VENDA.COD AS COD_VENDA, VENDA.DATA_VENDA, CLIENTE.COD AS CODIGO_CLIENTE, CLIENTE.NOME AS NOME_CLIENTE, VENDA.FILIAL, PRODUTO.NOME AS PRODUTO, PRODUTO.CATEGORIA, VENDA_PRODUTO.PRECO_UNITARIO, VENDA_PRODUTO.QUANTIDADE  FROM VENDA_PRODUTO INNER JOIN PRODUTO ON VENDA_PRODUTO.COD =  PRODUTO.COD INNER JOIN VENDA ON VENDA.COD = VENDA_PRODUTO.COD_VENDA INNER JOIN cliente ON venda.COD_cliente = cliente.COD WHERE venda.finalizada = true AND VENDA.FILIAL = "+filial_usuario+" AND DATA_VENDA >= '"+data_inicial+"' AND DATA_VENDA <= '"+data_final+"' AND CLIENTE.CODIGO = "+codCliente_selecionado;
    ...
    public static List<Relatorio> getVendasIntervalo(String data_inicial, String data_final, int codCliente_selecionado) {
        String query = "SELECT VENDA.COD AS COD_VENDA, VENDA.DATA_VENDA, CLIENTE.COD AS CODIGO_CLIENTE, CLIENTE.NOME AS NOME_CLIENTE, VENDA.FILIAL, PRODUTO.NOME AS PRODUTO, PRODUTO.CATEGORIA, VENDA_PRODUTO.PRECO_UNITARIO, VENDA_PRODUTO.QUANTIDADE  FROM VENDA_PRODUTO INNER JOIN PRODUTO ON VENDA_PRODUTO.COD =  PRODUTO.COD INNER JOIN VENDA ON VENDA.COD = VENDA_PRODUTO.COD_VENDA INNER JOIN cliente ON venda.COD_cliente = cliente.COD WHERE venda.finalizada = true AND DATA_VENDA >= '"+data_inicial+"' AND DATA_VENDA <= '"+data_final+"' AND cliente.cod = "+codCliente_selecionado;
    ...
    public static List<Comprador> getCompradoresIntervalo(String data_inicial, String data_final) {
        String query = "SELECT DISTINCT VENDA.COD_CLIENTE, CLIENTE.NOME AS NOME_CLIENTE FROM VENDA INNER JOIN VENDA_PRODUTO ON VENDA_PRODUTO.COD_VENDA = VENDA.COD INNER JOIN CLIENTE ON VENDA.COD_CLIENTE = CLIENTE.COD WHERE VENDA.FINALIZADA = TRUE AND DATA_VENDA >= '"+data_inicial+"' AND DATA_VENDA <= '"+data_final+"'";
    ...
    public static List<Comprador> getCompradoresIntervalo(int filial_usuario, String data_inicial, String data_final) {
        String query = "SELECT DISTINCT VENDA.COD_CLIENTE, CLIENTE.NOME AS NOME_CLIENTE FROM VENDA INNER JOIN VENDA_PRODUTO ON VENDA_PRODUTO.COD_VENDA = VENDA.COD INNER JOIN CLIENTE ON VENDA.COD_CLIENTE = CLIENTE.COD WHERE VENDA.FINALIZADA = TRUE AND VENDA.FILIAL = "+filial_usuario+" AND DATA_VENDA >= '"+data_inicial+"' AND DATA_VENDA <= '"+data_final+"'";
